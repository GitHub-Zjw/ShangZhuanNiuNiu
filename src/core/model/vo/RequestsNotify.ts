class RequestsNotify
{
	/**游戏首页数据 */
	public static Nuserinfo: string = "Showcattle/Nuserinfo";

	/**投注区域数据 */
	public static getbetm: string = "Showcattle/getbetm";

	/**当前庄家数据 */
	public static sideline_cbookmaker = "movecattle/cbookmaker";

	/**庄家亏盈数据 */
	public static sideline_bincome = "movecattle/bincome";
	...
	/**取消预约调仓 */
	public static sideline_canceltune = "movecattle/canceltune"
